...
def addleave():
    ...
    try:
        ...
        cursor.execute(insert_sql, (id, name, office, fdate, date, contact, team))
        db_conn.commit()
        # # Uplaod image file in S3 #
...
def Getleavet():
    ...
    try:
        ...
        db_conn.commit()
        print("Data fetched from MySQL RDS... fetching image from S3...")
        (id, name, office, fdate, contact, team, date) = cursor.fetchone()
    ...
    print("all modification done...")
    return render_template('GetLeaveOutput.html', id, name=name, office=office, fdate=fdate, date=date,
